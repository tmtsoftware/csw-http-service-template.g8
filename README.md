# This is a Giter8 template for a TMT app which creates a sample HTTP service project

The created project contains a sample service which includes the following :
...
`g8 tmtsoftware/csw-http-service-template.g8`
...
Once the project is generated, refer to the project's README for instructions on how to use, build, and run the each project.
